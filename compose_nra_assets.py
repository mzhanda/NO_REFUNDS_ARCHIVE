...
STAMP_MAP = {
    ...
    # 以下ID无独立文件，映射到最接近的实际文件
    "STAMP_OVERDUE":       "stamp_checked_out_red.png",
    "STAMP_NO_VACANCY":    "stamp_closed_red.png",
    "STAMP_FINAL_SALE":    "stamp_no_refunds_red.png",
    "STAMP_PAWN_HOLD":     "stamp_claim_closed_red.png",
    "STAMP_UNCLAIMED":     "stamp_claim_closed_red.png",
}
